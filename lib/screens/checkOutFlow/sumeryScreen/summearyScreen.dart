...
class SummearyScreen extends StatefulWidget {
  @override
  _SummearyScreenState createState() => _SummearyScreenState();
}

class _SummearyScreenState extends State<SummearyScreen>
    with AutomaticKeepAliveClientMixin<SummearyScreen> {
